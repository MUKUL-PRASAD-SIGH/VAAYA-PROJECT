...
export default function Stepper({
    ...
    return (
        <div className="outer-container" {...rest}>
            <div className={`step-circle-container ${stepCircleContainerClassName}`} style={{ border: '1px solid #e5e7eb' }}>
...
function StepContentWrapper({ isCompleted, currentStep, direction, children, className }) {
    ...
    return (
        <motion.div
            ...
            animate={{ height: isCompleted ? 0 : 'auto' }} // auto height might be safer for dynamic content
